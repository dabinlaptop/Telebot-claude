...
# حداکثر امتیاز ممکن = مجموع وزن‌ها * تعداد اندیکاتورها (4) = (1+2+3)*4 = 24
STRONG_SIGNAL_THRESHOLD = 12   # امتیاز >= این عدد => سیگنال قوی
WEAK_SIGNAL_THRESHOLD = 6      # امتیاز >= این عدد => سیگنال ضعیف
